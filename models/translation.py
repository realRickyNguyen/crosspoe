...
class CrossModalTranslator(nn.Module):
    ...
    Uses a fixed scalar gate alpha (default 0.75) applied uniformly to all
    pseudo-posterior contributions in the PoE fusion.
    ...
    def forward(self, mus, logvars, mask):
        ...
        Returns:
            ...
            gates             : list of [batch, 1] fixed-alpha gate tensors
        """
